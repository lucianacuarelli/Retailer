package modules.lg.model
{
	...
	public class UseLgDownloads extends UseTableModel
	{
		public function UseLgDownloads(){
			
			this._classNameModel = 'useLgDownloads';
			this._table = 'lg_downloads';
			this._alias = 'USE_LG_DOWNLOADS';
			this._idField = 'id';
			this._idFieldAlias = 'USE_LG_DOWNLOADS_id';
		...
		public function exprMYSQL(field:String, expr:String, alias:String = null, useTableAlias:Boolean=false):UseLgDownloads{
			this.expr(field, expr, alias, useTableAlias, 'MYSQL');
			return this;
		}
		
		public function exprSQLite(field:String, expr:String, alias:String = null, useTableAlias:Boolean=false):UseLgDownloads{
			this.expr(field, expr, alias, useTableAlias, 'SQLITE');
			return this;
		}
		
		public function setVar(field:String, value:String):UseLgDownloads{
