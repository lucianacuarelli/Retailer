package modules.lg.model
{
	...
	public class UseLgDownloadsComplete extends UseTableModel
	{
		public function UseLgDownloadsComplete(){
			
			this._classNameModel = 'useLgDownloadsComplete';
			this._table = 'lg_downloads_complete';
			this._alias = 'USE_LG_DOWNLOADS_COMPLETE';
			this._idField = 'id';
			this._idFieldAlias = 'USE_LG_DOWNLOADS_COMPLETE_id';
			
			this._fields[this._alias + "_created_in"] = "created_in";
			this._fields[this._alias + "_created_in_download"] = "created_in_download";
			this._fields[this._alias + "_download_type"] = "download_type";
		...
		public function exprMYSQL(field:String, expr:String, alias:String = null, useTableAlias:Boolean=false):UseLgDownloadsComplete{
			this.expr(field, expr, alias, useTableAlias, 'MYSQL');
			return this;
		}
		
		public function exprSQLite(field:String, expr:String, alias:String = null, useTableAlias:Boolean=false):UseLgDownloadsComplete{
			this.expr(field, expr, alias, useTableAlias, 'SQLITE');
			return this;
		}
		
		public function setVar(field:String, value:String):UseLgDownloadsComplete{
		...
		public function get dataAlias():Object{
			...
			data[this._alias + "_download_type"] = this.download_type;
		...
		private var _download_type:*;
		public function set download_type(download_type:*):void{
			this._download_type = UseUtil.checkData('download_type', download_type);
			this._data['download_type'] = isNull(this._download_type);
			this._isSave = true;
		}
		public function get download_type():*{ return this._download_type; }
